...
const ListarPedidosXVentas = ({navigation}) => {
	let textoMensaje = "";
	...
	const onPressHandler = () => {
		...
		setListaPedidosXVentas((prevLista) => {
			return prevLista.filter( (item) => item.NumeroFactura == filtro );
		});
	};
...
export default ListarPedidosXVentas;
